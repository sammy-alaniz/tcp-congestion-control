...
def dumbbell_test():
    ...
    print(command_one)
    sub_processes[h1] = h1.popen('iperf --forceflush -c {0} -p 1111 -i 1 -M 1460 -N -t 20 > iperf_test_h1-h3_15s.txt'.format(h3_ip), shell=True)
    ...
    sub_processes[h2] = h2.popen('iperf --forceflush -c {0} -p 2222 -i 1 -M 1460 -N -t 15 > iperf_test_h2-h4_15s.txt'.format(h4_ip), shell=True)
